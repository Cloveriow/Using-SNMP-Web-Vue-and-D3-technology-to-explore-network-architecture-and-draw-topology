    ...
    internal static class Program
    {
        public static void Main(string[] args)
        {
            ...
            foreach (Variable variable in result)
                {
                    string v; // 新增變數v
                    v = variable.ToString(); //變數v存放變數variable
                    int f1 = v.IndexOf("; Data: ");
                    v = v.Substring(0, f1 + 8);//處理變數v內容
                    Console.Write(v);//影出變數v內容

                    Console.WriteLine( variable.Data.TypeCode.ToString() == "OctetString" ? DecodeOctetString(variable.Data.ToBytes()) : variable.Data.ToString());
                }
            }
